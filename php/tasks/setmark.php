<?php
	...
	$rpid = 0;
	$onoff = 1; /* default: on */
	$marktype = 1; /* default: like */

	if(isset($_GET['id'])) $rpid = $_GET['id'];  /* extra data */
	if(!$rpid) die ("0");
	
		
	if(isset($_GET['m'])) $marktype = $_GET['m'];  /* extra data */
	if(isset($_GET['o'])) $onoff = $_GET['o'];  /* extra data */
	...
	echo $mcmark->add_mark($postuid, $postid, $noteid, $marktype, $onoff);
