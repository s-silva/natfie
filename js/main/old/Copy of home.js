...
/*                    back       title      text       */
var colorsets =    [["#fafafa", "#3a3a3a", "#4a4a4a"], 
...
function home_init()
{
	...
	if(getCookie("cards_chatbox") == "1")
	{
		...
		$("chatntf").style.right = '300px';
		chat_resize();
	}else{
		$("chatbox").style.visibility = 'hidden';
		$("chatntf").style.right = '0px';
	}
...
{
	$("chatcontent").style.height = window.innerHeight - 125 + 'px';
